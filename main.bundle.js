...
var routerConfig = [
    { path: 'about/:id/:name', component: __WEBPACK_IMPORTED_MODULE_3__about_about_component__["a" /* AboutComponent */] },
...
module.exports = "<div *ngFor=\"let item of abouts\" >\n  <a routerLink=\"/about/{{item.id}}/{{item.name}}\">{{item.name}}</a>\n</div>\n\n"
...
var ContactComponent = (function () {
    function ContactComponent() {
        this.abouts = [
            { id: 1, name: 'Trần Duy Phong' },
            { id: 2, name: 'PhongLocal' },
            { id: 3, name: 'PhongSn' }
        ];
    }
